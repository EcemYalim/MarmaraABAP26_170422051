CLASS zcl_170422051_rest_client_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170422051_rest_client_02 IMPLEMENTATION.
...
METHOD  run_demo.
  ...
  METHOD user_get.
    ...
    rv_text = execute_request(
      iv_method = 'GET'
      iv_url    = gc_base_url && '/user/ecekaya' ).
  ...
  METHOD user_delete.
    ...
    rv_text = execute_request(
      iv_method = 'DELETE'
      iv_url    = gc_base_url && '/user/demo_srpl' ).
...
METHOD build_user_json.
  rv_json =
    '{' &&
    '"id": 1,' &&
    '"username": "demo_170422051",' &&
    '"firstName": "Ece",' &&
    '"lastName": "Kaya",' &&
    '"email": "ece.demo@example.com",' &&
    '"password": "ece123",' &&
    '"phone": "5555555555",' &&
    '"userStatus": 1' &&
    '}'.
